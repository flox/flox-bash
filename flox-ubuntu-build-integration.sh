...
set -e 
set -o pipefail
export FLOXPATH="/home/ubuntu/flox"
...
flox build github:flox/floxpkgs#stable.flox --override-input flox github:flox/flox?rev="$1"
...
curl -O https://raw.githubusercontent.com/flox/flox/"$1"/test.bats
bats /home/ubuntu/actions-runner/_work/flox/flox/test.bats
#du -hDd0 /nix
rm -rf myproj
